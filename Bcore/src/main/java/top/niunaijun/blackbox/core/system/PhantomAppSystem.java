...
public class PhantomAppSystem {
    private static PhantomAppSystem sPhantomAppSystem;
    ...
    public static PhantomAppSystem getSystem() {
        if (sPhantomAppSystem == null) {
            synchronized (PhantomAppSystem.class) {
                if (sPhantomAppSystem == null) {
                    sPhantomAppSystem = new PhantomAppSystem();
                }
            }
        }
        return sPhantomAppSystem;
    }
